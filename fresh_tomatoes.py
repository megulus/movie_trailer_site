...
<head>
    <meta charset="utf-8">
    <title>80s Nostalgia Movies</title>
    <!-- Bootstrap 3 -->
      ...
      <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
          <div class="navbar-header">
            <a class="navbar-brand" href="#">80s Nostalgia with a Musical Twist</a>
          </div>
        </div>
      </div>
    </div>
...
# call open_movies_page function, kicking off the creation of html file for the movie site
